...
:size-mnemonic-strings size
  ...
  (let ((opcode-table
          (list
           ...
           (make-entry :opcode #x70 :mnemonic :JMP    :type :M  :size  10)
           (make-entry :opcode #x71 :mnemonic :JLE    :type :M  :size  10)
           (make-entry :opcode #x72 :mnemonic :JL     :type :M  :size  10)
           (make-entry :opcode #x73 :mnemonic :JE     :type :M  :size  10)
           (make-entry :opcode #x74 :mnemonic :JNE    :type :M  :size  10)
           (make-entry :opcode #x75 :mnemonic :JGE    :type :M  :size  10)
           (make-entry :opcode #x76 :mnemonic :JG     :type :M  :size  10)
           ...
           (make-entry :opcode #x80 :mnemonic :CALL   :type :M  :size  10)
